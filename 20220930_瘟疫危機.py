...
imgFloor = [
    ...
    pygame.image.load("image/mbox.png"),
...
EMY_NAME = [
    "大腸桿菌", "金黃色葡萄球菌", "仙人掌桿菌", "抗藥性葡萄球菌", "綜合細菌",
    "愛滋病毒", "狂犬病毒", "天花病毒", "新冠病毒", "新冠病毒(突變種)"
    ]
...
def main(): # 主要處理
    ...
    pygame.init()
    pygame.display.set_caption("瘟疫危機")
    ...
    while True:
        ...
        if idx == 0: # 標題畫面
            ...
            if fl_max >= 2:
                draw_text(screen, "你抵達拉坤市立醫院{}".format(fl_max), (300, 460), font, CYAN)
            ...
            if welcome > 0:
                welcome = welcome - 1
                draw_text(screen, "歡迎來到拉坤市醫院{}".format(floor), (300, 180), font, CYAN)
