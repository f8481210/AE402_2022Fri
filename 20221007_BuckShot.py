...
class Gun():
    ...
    def render_current_ammo(self, screen):
        text = self.font.render(str(self.bullet_count), False, (150,150,150))
...
class Game:
    def __init__(self, screen):
        ...
        self.bgpic = pygame.image.load("data/images/bg.png")
        self.screen = screen
        self.size = None
        self.width = None
        self.height = None
...
class Menu():
    ...
    def update(self):
        ...
        while is_menu:
            ...
            text = self.font.render("BuckShot", False, (50,50,50))
            ...
            highscore = self.font.render("Highscore: " + str(highscore_value), False, (130,130,130))
