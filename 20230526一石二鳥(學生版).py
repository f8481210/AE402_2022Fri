...
def main():
    ...
    projectileTex = pygame.image.load('data/gfx/bad_pig.png')
    polesTex = pygame.image.load('data/gfx/poles.png')
    backgroundTex = pygame.image.load('data/gfx/background.png')
    birdTex = pygame.image.load('data/gfx/angry_bird.png')
    birdTex_right = pygame.image.load('data/gfx/angry_bird_right.png')
    birdTex_left = pygame.image.load('data/gfx/angry_bird_left.png')
    ...
    while running:
        ...
        if currentLevel > 9:
            ...
            winText = font_48.render('Thank You For Playing.', True, (255, 255, 255))
